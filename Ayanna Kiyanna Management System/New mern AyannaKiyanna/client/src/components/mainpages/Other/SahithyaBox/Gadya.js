...
function Gadya() {
    ...
    return (
        <div className="Gadya-main-box">
            <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.2.1/css/all.min.css" integrity="sha512-MV7K8+y+gLIBoVD59lQIYicR65iaqukzvf/nwasF0nqhPay5w/9lJmVM2hMDcnK1OnMGCdVK+iQrJ7lzPJQd1w==" crossorigin="anonymous" referrerpolicy="no-referrer" />
            <section className='Gadya-section'>
                <div className='Gadya-container'>
                <h1>✥ ගද්‍ය </h1>
                    ...
                    <div className='Gadya-cards'>
                        <div className='Gadya-text-card'>
                        <Link className='Gadya-link' to="#">
                        ...
                        <div className='Gadya-text-card'>
                        <Link className='Gadya-link' to="/gadya/Nuthanagadya">
                            <i class="fa-solid fa-newspaper"></i>
                            <h3>නූතන ගද්‍ය</h3>
                            <h5>“අයන්න කියන්න” නමින් සිංහල සඟරාවක් පළ කිරීමේ අවශ්‍යතාව අප තුළ ඇතිව තිබූයේ මීට වසර ගණනාවකට ඔබ්බෙහි සිට ය.</h5>
                        </Link>
