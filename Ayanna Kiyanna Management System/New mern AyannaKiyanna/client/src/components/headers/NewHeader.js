    ...
    return (
        <section className='newheader'>
            ...
            <ul style={styleMenu}>
                ...
                <li><Link className='newheadlink' to="#" data-text="Info">{isAdmin ? 'Info' : 'Info'}</Link></li>
                <li><Link className='newheadlink' to="#" data-text="About">{isAdmin ? 'About' : 'About'}</Link></li>
                <li><Link className='newheadlink' to="#" data-text="Services">{isAdmin ? 'Services' : 'Services'}</Link></li>
